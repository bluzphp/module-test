...
class CreateTestTable extends AbstractMigration
{
    ...
    public function up()
    {
        $this->execute('INSERT INTO `acl_privileges` (`roleId`, `module`, `privilege`) VALUES (\'2\',\'test\',\'Create\'),(\'2\',\'test\',\'Delete\'),(\'2\',\'test\',\'Read\'),(\'2\',\'test\',\'Update\');');
        ...
        $this->execute('INSERT INTO `test`(`id`,`name`,`email`,`status`) VALUES (10,\'Jonah\',\'dictum@pharetra . ca\',\'disable\'),(11,\'Connor\',\'congue . In . scelerisque@Integervulputaterisus . ca\',\'disable\');');
    }
    /**
     * Migrate Down.
     */
